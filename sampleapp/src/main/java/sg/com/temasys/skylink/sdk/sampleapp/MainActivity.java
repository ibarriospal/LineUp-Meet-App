...
public class MainActivity extends ActionBarActivity
    ...
    private static final int CASE_FRAGMENT_AUDIO_CALL = 2;
    private static final int CASE_FRAGMENT_VIDEO_CALL = 1;
    private static final int CASE_FRAGMENT_CHAT = 3;
    private static final int CASE_FRAGMENT_FILE_TRANSFER = 4;
    private static final int CASE_FRAGMENT_DATA_TRANSFER = 5;
    private static final int CASE_FRAGMENT_MULTI_PARTY_VIDEO_CALL = 0;
